...
const Features = () => {
  return (
    <>
     <section id="features" className="pt-14 sm:pt-20 lg:pt-[5px]">
      <div className="px-4 xl:container">
        ...
        >
          ...
          >
          Tu es unique, ton montage aussi !
          </h2>
          <p className="text-base text-dark-text">
            Nous accompagnons les créateurs de contenu qui souhaitent se démarquer avec un petit budget. 
          </p>
        </div>
              ...
              <div>
                ...
                <div className="counter">
                  <div className="box">
                      ...
                      <span>+</span> <NumberCounter initialValue={0} targetValue={100} duration={2000} /> <span>% Polyvalent</span>                        
                  </div>
              </div>
              </h2>
                <p className="text-base text-dark-text">
            ...
            >
              ...
              <div>
                ...
                <div className="counter">
                  <div className="box">
                      <i className="fas fa-user-graduate"></i>
                      <span>+</span> <NumberCounter initialValue={0} targetValue={22} duration={2000} /> <span>% Polyvalent</span>                         
                  </div>
              </div>
                </h3>
                <p className="text-base text-dark-text">
                  Monteurs free-lance partenaires
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div>
                ...
                <div className="counter">
                  <div className="box">
                      <i className="fas fa-user-graduate"></i>
                      <NumberCounter initialValue={0} targetValue={80} duration={2000} /> <span>% Polyvalent</span>   <span>%</span>                     
                  </div>
              </div>
                </h3>
                <p className="text-base text-dark-text">
                  De nos clients reviennent vers nous !
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div>
                <h3
                  className="mb-3 font-heading text-xl font-medium text-dark dark:text-white sm:text-2xl md:mb-5"
                >
                <span>+</span><NumberCounter initialValue={0} targetValue={10} duration={2000} /> <span>% Polyvalent</span>    <span>Heures</span>   
                </h3>
                <p className="text-base text-dark-text">
                  De temps gagner en moyenne 
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div>
                <h3
                  className="mb-3 font-heading text-xl font-medium text-dark dark:text-white sm:text-2xl md:mb-5"
                >
                 <NumberCounter initialValue={0} targetValue={100} duration={2000} /> <span>% Polyvalent</span>   
                </h3>
                <p className="text-base text-dark-text">
                 Vlog/ IRL - Face-cam - Evenement
                </p>
              </div>
            </div>
          </div>
